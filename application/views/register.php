    ...
    <div class="container h-100">
        ...
        <div class="row justify-content-center h-100">
            <div class="col-md-5 my-auto">
                <h2 class="text-center text-danger mb-3">Enter your details to register</h2>
                ...
                <input class="form-control mb-3" type="password" name="confpass" placeholder="Confirm your password" value="<?php echo set_value('confpass'); ?>">
